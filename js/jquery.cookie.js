...
<meta content="collector.githubapp.com" name="octolytics-host" /><meta content="collector-cdn.github.com" name="octolytics-script-host" /><meta content="github" name="octolytics-app-id" /><meta content="5F92CFFD:1164:1A48F75D:56142B2B" name="octolytics-dimension-request_id" />
...
<meta content="t9PnXl7onjts0ywJYUN0Vx1+eJHbR59QZveJP4Rw60yFMtePHrAYSkZjwwsnwTz1eVcyTQb8vRf/C4j5p7Ncxw==" name="csrf-token" />
...
<div class="clone-options text-small">You can clone with
  <!-- </textarea> --><!-- '"` --><form accept-charset="UTF-8" action="/users/set_protocol?protocol_selector=http&amp;protocol_type=clone" class="inline-form js-clone-selector-form " data-form-nonce="1dfc62a655d8f1f64db96c273690c4650f83d0f0" data-remote="true" method="post"><div style="margin:0;padding:0;display:inline"><input name="utf8" type="hidden" value="&#x2713;" /><input name="authenticity_token" type="hidden" value="d1XM+1qUOTp63A6DlZbyQHWNKvCMemfTPshtbbQzY9dHBZuXxOSsfkomz9XEyH00FY93bK6gYn4b0QZgZt2Tfw==" /></div><button class="btn-link js-clone-selector" data-protocol="http" type="submit">HTTPS</button></form> or <!-- </textarea> --><!-- '"` --><form accept-charset="UTF-8" action="/users/set_protocol?protocol_selector=subversion&amp;protocol_type=clone" class="inline-form js-clone-selector-form " data-form-nonce="1dfc62a655d8f1f64db96c273690c4650f83d0f0" data-remote="true" method="post"><div style="margin:0;padding:0;display:inline"><input name="utf8" type="hidden" value="&#x2713;" /><input name="authenticity_token" type="hidden" value="4FyUdvfYgWrDVLjGvTEQtkdA4wi7tK6BvgG+/MGgEJKinM0cqrZyCJnqZgGbK9GchvVC5uYM7X1JDOAfseBLJQ==" /></div><button class="btn-link js-clone-selector" data-protocol="subversion" type="submit">Subversion</button></form>.
  <a href="https://help.github.com/articles/which-remote-url-should-i-use" class="help tooltipped tooltipped-n" aria-label="Get help on which URL is right for you.">
    <span class="octicon octicon-question"></span>
  </a>
</div>
  <a href="https://mac.github.com" class="btn btn-sm sidebar-button" title="Save carhartl/jquery-cookie to your computer and use it in GitHub Desktop." aria-label="Save carhartl/jquery-cookie to your computer and use it in GitHub Desktop.">
...
<div id="jump-to-line" style="display:none">
  ...
  <div class="site-footer" role="contentinfo">
    ...
    <ul class="site-footer-links">
      <li>&copy; 2015 <span title="0.04987s from github-fe140-cp1-prd.iad.github.net">GitHub</span>, Inc.</li>
